...
class AutoScale(nn.Module):
    def __init__(self, load_weights=False):
        ...
        self.dsn1 = nn.Conv2d(40, 2, 1)
        self.dsn2 = nn.Conv2d(40, 2, 1)
        self.dsn3 = nn.Conv2d(40, 2, 1)
        self.dsn4 = nn.Conv2d(40, 2, 1)
        self.dsn5 = nn.Conv2d(32, 2, 1)
        self.dsn6 = nn.Conv2d(8, 2, 1)
